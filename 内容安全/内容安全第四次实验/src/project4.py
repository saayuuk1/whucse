...
sys.path.append(r'C:/Users/22848/Desktop/Prominent/内容安全/内容安全第四次实验/Face-X-Ray-2')
...
def main():
    ...
    for i, srcFace in enumerate(srcFaces):
        ...
        # save face images
        cv2.imwrite(f'../Face-X-Ray-2/dump/mask_{i}.jpg', hullMask)
        cv2.imwrite(f'../Face-X-Ray-2/dump/deformed_{i}.jpg', warped*255)
        cv2.imwrite(f'../Face-X-Ray-2/dump/blured_{i}.jpg', blured*255)
        cv2.imwrite(f'../Face-X-Ray-2/dump/src_{i}.jpg', srcFaceBgr)
        cv2.imwrite(f'../Face-X-Ray-2/dump/target_{i}.jpg', targetBgr)
        cv2.imwrite(f'../Face-X-Ray-2/dump/target_T_{i}.jpg', targetBgrT)
        cv2.imwrite(f'../Face-X-Ray-2/dump/forge_{i}.jpg', resultantFace)
...
def get_parser():
    ...
    parser.add_argument('--shapePredictor', '-sp', type=str, default='../models/shape_predictor_68_face_landmarks.dat', help='Path to dlib facial landmark predictor model')
